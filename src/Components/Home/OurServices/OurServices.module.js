...
export default function OurServices() {
  const serviceInfo = [
    {
      image: "https://i.ibb.co/vB6cSjx/img3.jpg",
      name: "Business Meeting",
      Sprice: 1200,
      ePrice: 2000,
    },
    {
      image: "https://i.ibb.co/M2W5Hm9/img1.jpg",
      name: "Wedding Party",
      Sprice: 2500,
      ePrice: 5000,
    },
    {
      image: "https://i.ibb.co/DDbg7n4/img2.jpg",
      name: "Birthday Party",
      Sprice: 500,
      ePrice: 2000,
    },
    ...
    <div className={`px-80 pt-7 bg-gray-100`}>
      ...
      >
        {serviceInfo.map((service, index) => (
          <SwiperSlide key={index} className={style.hit}>
            <div>
              <div className="">
