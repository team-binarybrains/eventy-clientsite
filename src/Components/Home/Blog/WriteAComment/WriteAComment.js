        ...
        <div>
            ...
            <div>
               <form >
                ...
                <input type="text" placeholder="Name" className="md:w-[236px]  w-full h-[52px] px-5  py-4 outline-amber-300 block mt-5  bg-[#f7f7f7]"/>
                <input type="email" placeholder="Email" className="md:w-[236px] w-full h-[52px] px-5 py-4 outline-amber-300 block mt-5  bg-[#f7f7f7]"/>
