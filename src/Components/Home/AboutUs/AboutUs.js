    ...
    return (
        <div className='flex justify-around py-20 bg-gray-100'>
            <div className='-mr-96 grid items-center w-96'>
                <div>
                    <div className='border-t w-[60px] -ml-5 border-black'><p className=''></p></div>
                    ...
                    <div className='flex justify-center mt-10'>
                        <button className='uppercase'>about eventy</button>
                    </div>
                </div>
            </div>
            ...
            <div className='grid justify-center w-[800px]'>
                ...
                <div className='flex'>
                    <div className='h-[230px] w-[230px] border grid items-center justify-center'>
                        <p className='flex justify-center'><GiShakingHands className='text-5xl' /></p>
                    ...
                    <div className='h-[230px] w-[230px] border grid items-center justify-center'>
                        <p className='flex justify-center'><GiBalloons className='text-5xl' /></p>
                        <div className='-mt-16 px-3'>
                    ...
                    <div className='h-[230px] w-[230px] border grid items-center justify-center'>
                        <p className='flex justify-center'><FaGlassCheers className='text-5xl' /></p>
                        <div className='-mt-16 px-3'>
                ...
                <div className='flex'>
                    <div className='h-[230px] w-[230px] border grid items-center justify-center'>
                        <p className='flex justify-center'><FiFilm className='text-5xl' /></p>
                        <div className='-mt-16 px-3'>
                    ...
                    <div className='h-[230px] w-[230px] border grid items-center justify-center'>
                        <p className=' flex justify-center'><FiPhoneCall className='text-5xl' /></p>
                        <div className='-mt-16 px-3'>
                    ...
                    <div className='h-[230px] w-[230px] border grid items-center justify-center'>
                        <p className='flex justify-center'><HiLightBulb className='text-5xl' /></p>
                        <div className='-mt-16 px-3'>
