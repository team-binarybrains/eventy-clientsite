    ...
    return (
        <div className="backgroundImage">
          <div className="md:flex justify-around items-center py-10">
            <div>
                <h1 className=" tracking-widest"><span className="text-7xl font-black px-1 text-white">30%</span> <span className="text-4xl text-white">Off In June~July</span> <span className="text-4xl  text-white font-black">For Birthday Events</span></h1>
