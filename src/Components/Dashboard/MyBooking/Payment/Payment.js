...
const Payment = () => {
  ...
  const [ticket, loading, refetch] = useRefetch(`https://eventy-server.onrender.com/ticket-booking/${Id}`, {})


  const { data: product, isLoading } = useQuery(['payment', Id], () => fetch(`https://eventy-server.onrender.com/payment/${Id}`, {
    method: 'GET',
    // headers: {
