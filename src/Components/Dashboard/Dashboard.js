      ...
      <div className="drawer drawer-mobile pt-0">
        ...
        <div className="drawer-content  flex flex-col bg-slate-200">
          ...
          <div className="text-left mt-4 z-[1111111] fixed">
            <label htmlFor="open-dashboard-menu" className="rounded inline-block cursor-pointer text-white lg:hidden z-50"><span className="text-2xl bg-gradient-to-r from-[#FF4402] to-[#f5ac1a] hover:bg-gradient-to-l from-[#e73f02] to-[#ffaa00] px-4 py-2 rounded shadow-2xl">
