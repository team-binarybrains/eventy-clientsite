                ...
                <div className={`${styleLg.overlayContainer}`}>
                    <div className={`${styleLg.overlay}`}>
                        <div className={`${styleLg.overlayPanel} ${styleLg.overlayLeft} space-y-5`}>
                            ...
                            <button className={`${styleLg.ghost} ${styleLg.button} bg-gradient-to-r from-[#ff4b2bee] to-orange-400`} id="signIn" onClick={()=> {
                                setActivePanel(" ");
                            }}>Sign In</button>
                        </div>
                        <div className={`${styleLg.overlayPanel} ${styleLg.overlayRight} space-y-5`}>
                            ...
                            <button className={`${styleLg.ghost} ${styleLg.button} bg-gradient-to-r from-orange-400 to-[#ff4b2bee]`} id="signUp" onClick={()=> {
