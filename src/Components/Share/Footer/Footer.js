               ...
               <div class="">
                  <div class="">
                     ...
                     <ul className='py-6'>
                        ...
                        <li className='text-base flex items-center gap-2  border-b border-slate-500 py-2 '><a href='/eventlist' id='usefulHover' className='flex gap-2 items-center'><BiRightArrowAlt className='bg-zinc-500 w-5 h-5 rounded-full text-[#333333] ' /> Event Listing</a></li>
                        ...
                        <li className='text-base flex items-center gap-2  border-b border-slate-500 py-2 '><a href='/home#upcoming-event' id='usefulHover' className='flex gap-2 items-center'><BiRightArrowAlt className='bg-zinc-500 w-5 h-5 rounded-full text-[#333333] ' />Upcoming Events</a></li>
                        <li className='text-base flex items-center gap-2  border-b border-slate-500 py-2 '><a href='/home#partner-client' id='usefulHover' className='flex gap-2 items-center'><BiRightArrowAlt className='bg-zinc-500 w-5 h-5 rounded-full text-[#333333] ' /> Partners & Clients</a></li>
                        <li className='text-base flex items-center gap-2  border-b border-slate-500 py-2 '><a href='/home#venues' id='usefulHover' className='flex gap-2 items-center'><BiRightArrowAlt className='bg-zinc-500 w-5 h-5 rounded-full text-[#333333] ' /> Venues</a></li>
                        <li className='text-base flex items-center gap-2  border-b border-slate-500 py-2 '><a href='/home#upcoming-event' id='usefulHover' className='flex gap-2 items-center'><BiRightArrowAlt className='bg-zinc-500 w-5 h-5 rounded-full text-[#333333] ' /> Tickets</a></li>
                        <li className='text-base flex items-center gap-2  border-b border-slate-500 py-2 '><a href='/faq' id='usefulHover' className='flex gap-2 items-center'><BiRightArrowAlt className='bg-zinc-500 w-5 h-5 rounded-full text-[#333333] ' /> Ask & Questions</a></li>
                     </ul>
