...
function Catering() {
    ...
    const catering = useFetch(`http://localhost:5000/get-sub-services/catering`)
                ...
                <div className='grid lg:flex justify-center gap-x-6'>
                    ...
                    <div className='lg:w-4/12 px-3 lg:px-0 py-10 lg:py-0'>
                        <p className='uppercase text-3xl font-semibold'
                            data-aos="fade-left"
                            data-aos-duration="2000"
                        > <span className='text-amber-400 tracking-widest'>eventy</span> SPECIALTY CATERING</p>
                        <p className='py-8'
                            data-aos="fade-left"
                            data-aos-delay="200"
                            data-aos-duration="2000"
                ...
                <div className='lg:flex justify-center items-center gap-x-7 lg:h-80 pt-5 lg:pt-0'>
                    <div className='lg:w-4/12 px-3 lg:px-0'>
                        ...
                        <p className='mt-5'
                            data-aos="zoom-in"
                            data-aos-duration="2000"
                        >Sometimes it is difficult to be at a swanky event and the only meal available to vegetarians and vegans are steamed veggies. We can prepare flavorful vegetarian meals with 3 – 4 options. We can even provide certified organic ingredients for a nominal fee.</p>
                    </div>
                    <div className='grid gap-y-3 lg:w-4/12 mt-6 lg:mt-0 px-3 lg:px-0'>
                        <p className='bg-amber-400 p-2 text-gray-600'
                            data-aos="flip-down"
                            data-aos-duration="2000"
                        >Vegan Menus (No Animal Flesh, Milk, Wheat or Eggs)</p>
                        <p className='bg-amber-400 p-2 text-gray-600'
                            data-aos="flip-down"
                            data-aos-duration="2000"
                        >Vegetarian (No Meat, Vegetables, Eggs, Milk, Wheat or Soy)</p>
                    </div>
                </div>
            </div>
