    ...
    return (
        <div className='grid grid-cols-12 gap-8'>
            <div className='col-span-12 sm:col-span-8'>
                <h3 className='text-3xl'>Order <span className='font-bold'>Summary</span></h3>
                ...
                <div class="overflow-x-auto p-8 bg-white mt-8 mb-12">
                    <table class="table w-full font-bold text-center">
                        <tbody>
                            ...
                            <tr>
                                <td className='bg-slate-100'>Harmoni Package 1</td>
                ...
                <h3 className='text-3xl mb-7'>Registration <span className='font-bold'>Information</span></h3>

                <div className='grid grid-cols-1 sm:grid-cols-12 gap-10 mb-12'>
                    <div className='col-span-6'>
                        <h4 className='text-2xl font-bold mb-4'>TICKET BUYER</h4>
                    ...
                    <div className='col-span-6'>
                        <h4 className='text-2xl font-bold mb-4'>PAYMENT</h4>
                        ...
                        <h5 style={{ margin: "18px 0px" }} className='text-lg font-bold'>Expired Date</h5>
                ...
                <div className='mb-12'>
                    <h3 className='text-3xl mb-7'>Billing <span className='font-bold'>Information</span></h3>
                    <div className='flex flex-col gap-2'>
                ...
                <div className='text-center'>
                    <button className='py-4 px-9 custom-btn rounded-full uppercase font-semibold text-white'>Pay Now</button>
                </div>
