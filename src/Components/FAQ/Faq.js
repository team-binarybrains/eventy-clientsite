    ...
    return (
        <div className='route'>
            <div className="py-20 bg-[url('/src/asset/12tmag-switzerland-slide-E5KB-superJumbo.jpg')] bg-fixed bg-no-repeat bg-cover text-center">
                <h4 style={{ wordSpacing: "4px", letterSpacing: "5px" }} className='font-semibold text-lg text-white'>HARMONI EVENTS</h4>
                <h2 className='text-5xl font-semibold mt-5 text-white'>HARMONI <span className='font-bold text-amber-400'>FAQ</span></h2>
                    ...
                    <div class="modal modal-middle">
                        <div class="modal-box relative">
                            ...
                            <div class="form-control">
                                ...
                                <textarea onChange={(e) => setQuestion(e.target.value)} class="textarea textarea-bordered h-28 rounded-none focus:outline-none focus:border-amber-400" placeholder="Please type, what you want to know about..." value={question}></textarea>
                            </div>

                            <div class="modal-action justify-center">
                                <label onClick={() => handleQuestion()} for={`${question && "my-modal-6"}`} class="py-3 px-10 custom-btn rounded-full uppercase font-semibold text-white">Submit</label>
                            </div>
                        </div>
                    </div>
                        ...
                        {firstAccountQuestion.map(faq => <div key={faq.questionNumber} tabindex="0" class="collapse collapse-arrow bg-base-100">
                            ...
                            <div class="collapse-content p-0 border-l-2 bg-white peer-checked:border-l-[3px] peer-checked:border-l-amber-400 peer-checked:bg-stone-100">
                                <div className='p-7 pb-5'>
                                    <h5 className='text-amber-400 font-bold mb-4 text-lg'>Answer</h5>
                                    <p>{faq.Answer}</p>
                                </div>
                            </div>
                        </div>)}
